...
(
    ...
    Planta NUMBER(2),
    CONSTRAINT SEC_PK PRIMARY KEY (Denominacion, N_CComercial),
...
(
    ...
    CONSTRAINT DENNCC_SEC_FK FOREIGN KEY (Denominacion, N_CComercial) REFERENCES SECCION,
    CONSTRAINT NDN_DEP_PK PRIMARY KEY (Nombre, Denominacion, N_CComercial)
);
...
(
    ...
    Denominacion_Departamento VARCHAR2(40),
    N_CComercial VARCHAR2(40),
    CONSTRAINT NUMEMP_VEN_FK FOREIGN KEY (NumEmpleado) REFERENCES EMPLEADO,
    CONSTRAINT DENNCC_VEN_FK FOREIGN KEY (Nombre_Departamento, Denominacion_Departamento, N_CComercial) REFERENCES DEPARTAMENTO,
...
(
    ...
    Denominacion_Producto VARCHAR2(40),
    Stock NUMBER(10) NOT NULL,
    Nombre_Departamento VARCHAR2(40),
    Denominacion_Departamento VARCHAR2(40),
    N_CComercial VARCHAR2(40),
    CONSTRAINT DENNCC_PROD_FK FOREIGN KEY (Nombre_Departamento, Denominacion_Departamento, N_CComercial) REFERENCES DEPARTAMENTO,
...
(
    ...
    CONSTRAINT NDDENCC_TDES_FK FOREIGN KEY(Nombre_Departamento, Denominacion, N_CComercial) REFERENCES DEPARTAMENTO,
    CONSTRAINT NTCNDDENCC_TDES_PK PRIMARY KEY (Nombre_TC, Nombre_Departamento, Denominacion, N_CComercial)
);
...
INSERT INTO CLIENTE VALUES ('8328428P', 'Daniel', 'Muñoz', '', 'Avda. Portugal Nº 33', 654762782);
